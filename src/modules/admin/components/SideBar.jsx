  ...
  return (
    <div>
            ...
            <li>
              <Link to="contracts">
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Contratos</span>
      ...
      <div className="p-4 sm:ml-64">
        <div className=" sm:ml-0 p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-11">
          <Outlet />
        </div>
      </div>
    </div>
