...
import FormTrainingComponent from "../components/Training/FormTrainingComponent"
...

            {
                activateForm === false ? 
                    <div className="ps-4 pb-12 h-full flex justify-between items-center">
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Listado de Capacitaciones</h1>
                        <Button 
                ...
                <div className="ps-4 pb-12 h-full flex items-center">
                    ...
                    {activateForm && (
                        ...
                        {activateForm === false ? <ViewTrainingComponent /> : <FormTrainingComponent />}
